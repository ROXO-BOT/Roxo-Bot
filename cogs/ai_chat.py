...
# ⚠️ عدّل هاد الجزء (خصوصاً "معلومات السيرفر") بمعلومات FASTLIFE ROLEPLAY
#    الحقيقية ديالك (المؤسس، التخصص، القوانين...) قبل ما تخدم بيه فـ الإنتاج.
SYSTEM_PROMPT = """
أنت FastLife AI، مساعد ذكي ورسمي داخل سيرفر FASTLIFE ROLEPLAY على Discord.
...
class AIGroup(app_commands.Group):
    def __init__(self, bot: commands.Bot):
        super().__init__(name="ai", description="🤖 FastLife AI — powered by Groq")
        self.bot = bot
